...
class sState:
    ...
    def load(self):
        ...
        self.bs.readUInt() # size of material name
        self.bs.bytesToString(self.bs.readBytes(self.bs.readUShort())).replace("\0", "") # material name
        self.bs.readUInt() # size of info material name
        self.bs.bytesToString(self.bs.readBytes(self.bs.readUShort())).replace("\0", "") # info material name
...
class sDisplayList:
    ...
    def readProperties(self):
        ...
        # blendGeometry ?
        self.bs.readBytes(self.bs.readUInt()) # unknown signature
...
class sTexture:
    ...
    def readTextureProperties(self):
        ...
        self.uvSetIndex = self.bs.readUByte()
        
        self.textureType = self.bs.readUByte()
        self.textureID = self.bs.readUByte()
        self.textureImage = self.bs.readUShort()
            ...
            for shapeHeader in self._sSceneDatabase.shapeHeaderSignatures:
                ...
                for shape in _sShapeHeader.shape:
                    ...
                    if _sShape.displayList not in self._sSceneDatabase.displayList:
                        ...
                        _sDisplayList = sDisplayList(binaryReader)
                        print(binaryReader.tell())
